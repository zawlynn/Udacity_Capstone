package com.zawlynn.udacitycapstoneproject.ui.player;
...
import com.zawlynn.udacitycapstoneproject.ui.podcast.PodcastActivity;
...
public class OfflinePlayerActivity extends AppCompatActivity implements IPodcastListener, MediaBrowserHelperCallback, OnNetworkStateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        episodes =getIntent().getParcelableArrayListExtra(Constant.EPISODES);
